                  ...
                  <div className="card-body p-4">
                    <div className="d-flex text-black">
                      ...
                      <div className="flex-grow-1 ms-3" style={{ width: 500 }}>
                        <h5 className="mb-1">{selectedUserId.name}</h5>
                        <div
                        ...
                        >
                          <div>
                            ...
                            <p className="mb-0">{selectedUserId.age}</p>
                          </div>
                          <div className="px-3">
                            <p className="small text-muted mb-1">Email</p>
                            <p className="mb-0">{selectedUserId.email}</p>
                          </div>
                          <div>
                            <p className="small text-muted mb-1">Phone Number</p>
                            <p className="mb-0">{selectedUserId.phoneNo}</p>
                          </div>
                        </div>
